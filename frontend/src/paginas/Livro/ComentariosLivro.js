export default function ComentarioLivro({comentario}) {
    return (
        <div key={comentario.comentarioId} className="bg-white shadow overflow-hidden sm:rounded-lg mb-4 p-4">
            <div className="px-4 py-5 sm:px-6 flex items-center">
                <img src={comentario.avatarUrl ? comentario.avatarUrl : "/default.png" } alt="Avatar do user" className="w-10 h-10 rounded-full mr-4"/>
                <div>
                    <h1 className="mb-2">TODO: Nome do user</h1>
