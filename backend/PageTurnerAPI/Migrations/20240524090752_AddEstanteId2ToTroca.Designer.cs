...
namespace PageTurnerAPI.Migrations
{
    ...
    [Migration("20240524090752_AddEstanteId2ToTroca")]
    partial class AddEstanteId2ToTroca
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.Troca", b =>
                {
                    ...
                    b.HasOne("backend.Models.Estante", "Estante")
                        .WithMany()
                        .HasForeignKey("estanteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Models.Estante", "Estante2")
                        .WithMany()
                        .HasForeignKey("estanteId2")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Estante");

                    b.Navigation("Estante2");
