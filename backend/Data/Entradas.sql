...
--Avaliacao
-- Insert three entries into [AvaliacaoLivro]
INSERT INTO [dbo].[AvaliacaoLivro] ([nota], [dataAvaliacao], [utilizadorID], [livroId]) 
VALUES 
    (4, GETDATE(), 1, 1), -- Example 1
    (5, GETDATE(), 2, 2), -- Example 2
    (3, GETDATE(), 3, 3); -- Example 3
